...
class MenuResourceIT {
    ...
    public static Menu createEntity(EntityManager em) {
        Menu menu = new Menu().name(DEFAULT_NAME).code(DEFAULT_CODE).createdDate(DEFAULT_CREATED_DATE).modifiedDate(DEFAULT_MODIFIED_DATE);
        return menu;
    }
    ...
    public static Menu createUpdatedEntity(EntityManager em) {
        Menu menu = new Menu().name(UPDATED_NAME).code(UPDATED_CODE).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
        return menu;
    }
    ...
    void createMenu() throws Exception {
        ...
        assertThat(testMenu.getModifiedDate()).isEqualTo(DEFAULT_MODIFIED_DATE);
    }
    ...
    void putNewMenu() throws Exception {
        ...
        updatedMenu.name(UPDATED_NAME).code(UPDATED_CODE).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
        ...
        assertThat(testMenu.getModifiedDate()).isEqualTo(UPDATED_MODIFIED_DATE);
    }
    ...
    void partialUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.modifiedDate(UPDATED_MODIFIED_DATE);
    ...
    void fullUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.name(UPDATED_NAME).code(UPDATED_CODE).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
