...
/**
 * Service Interface for managing {@link com.mycompany.myapp.domain.ProductCategory}.
 */
public interface ProductCategoryService {
    ...
    /**
     * Get all the ProductCategoryDTO where EveryProduct is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<ProductCategoryDTO> findAllWhereEveryProductIsNull();
