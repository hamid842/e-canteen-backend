...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    /**
     *  Get all the productCategories where EveryProduct is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<ProductCategoryDTO> findAllWhereEveryProductIsNull() {
        log.debug("Request to get all productCategories where EveryProduct is null");
        return StreamSupport
            .stream(productCategoryRepository.findAll().spliterator(), false)
            .filter(productCategory -> productCategory.getEveryProduct() == null)
            .map(productCategoryMapper::toDto)
