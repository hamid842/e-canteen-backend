...
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategoryDTO>> getAllProductCategories(
        ...
        if ("everyproduct-is-null".equals(filter)) {
            log.debug("REST request to get all ProductCategorys where everyProduct is null");
            return new ResponseEntity<>(productCategoryService.findAllWhereEveryProductIsNull(), HttpStatus.OK);
        }
