...
public class UserAccountResource {
    ...
    public ResponseEntity<List<UserAccountDTO>> getAllUserAccounts(
        ...
        if ("everyaccount-is-null".equals(filter)) {
            log.debug("REST request to get all UserAccounts where everyAccount is null");
            return new ResponseEntity<>(userAccountService.findAllWhereEveryAccountIsNull(), HttpStatus.OK);
        }
