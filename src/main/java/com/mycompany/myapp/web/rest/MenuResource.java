...
public class MenuResource {
    ...
    public ResponseEntity<List<MenuDTO>> getAllMenus(
        ...
        if ("everymenu-is-null".equals(filter)) {
            log.debug("REST request to get all Menus where everyMenu is null");
            return new ResponseEntity<>(menuService.findAllWhereEveryMenuIsNull(), HttpStatus.OK);
        }
