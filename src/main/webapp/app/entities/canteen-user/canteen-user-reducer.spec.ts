...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANTEENUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CANTEENUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CANTEENUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CANTEENUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CANTEENUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CANTEENUSER actions', async () => {
      const expectedActions = [
        {
