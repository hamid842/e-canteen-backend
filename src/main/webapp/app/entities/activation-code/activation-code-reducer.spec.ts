...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVATIONCODE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVATIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVATIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVATIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVATIONCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVATIONCODE actions', async () => {
      const expectedActions = [
        {
