...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERORDER actions', async () => {
      const expectedActions = [
        {
