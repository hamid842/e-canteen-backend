...
export const ProductCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCanteenApp.productCategory.delete.question">
        <Translate contentKey="eCanteenApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
